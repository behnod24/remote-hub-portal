        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 pt-4">
              <a 
                href="#" 
                className="p-2 bg-gray-800 rounded-lg hover:bg-red-900 transition-colors duration-300"
                aria-label="Twitter"
              >
              ...
              <a 
                ...
                aria-label="LinkedIn"
              >
                <Linkedin className="h-5 w-5 text-gray-400 hover:text-red-400" />
              </a>
              <a 
                href="#" 
                className="p-2 bg-gray-800 rounded-lg hover:bg-red-900 transition-colors duration-300"
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link to="/about" className="text-gray-400 hover:text-red-400 transition-colors duration-300">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/careers" className="text-gray-400 hover:text-red-400 transition-colors duration-300">
                  Careers
                </Link>
              </li>
              <li>
                <Link to="/blog" className="text-gray-400 hover:text-red-400 transition-colors duration-300">
                  Blog
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link to="/help" className="text-gray-400 hover:text-red-400 transition-colors duration-300">
                  Help Center
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="text-gray-400">
                ...
                <br />
                <a href="mailto:contact@pamirhub.com" className="hover:text-red-400 transition-colors duration-300">
        ...
        <div className="border-t border-gray-800 mt-16 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6">
              ...
              <Link to="/cookies" className="text-gray-400 hover:text-red-400 text-sm transition-colors duration-300">
                Cookies
              </Link>
            </div>
          </div>
