...
export default function DashboardHeader({
  ...
  return (
    <header className="flex flex-col md:flex-row items-center justify-between border-b border-[#292929] px-4 md:px-10 py-3 mt-16 md:mt-0">
      ...
      <div className="flex w-full md:w-auto flex-1 justify-end gap-4">
        <div className="flex min-w-40 max-w-64 w-full md:w-auto">
